...
box-shadow: 0 -1px 0 #114566 inset,1px 0 0 #114566 inset;
		...
		<style type="text/css">    
body{margin: 0;padding: 0;background: white url(images/bgdemo2.jpg);}
#main{width: 100%;margin: 20px auto 0 auto;background: white;-moz-border-radius: 8px;-webkit-border-radius: 8px;padding: 30px;border: 1px solid #adaa9f;-moz-box-shadow: 0 2px 2px #9c9c9c;-webkit-box-shadow: 0 2px 2px #9c9c9c;}
...
<div id="main">
<br><s:if test="tag==1">
<div><font color="#ff0000">文件删除失败！请检查文件是否正在打开！</font></div>
</s:if>
<table class="features-table">
	<tr>
		<td class="col-cell col-cell1 col-cellh">名称</td>
		<td class="col-cell col-cell1 col-cellh">上传人</td>
		<td class="col-cell col-cell2 col-cellh">会员</td>
		<td class="col-cell col-cell3 col-cellh">上传时间</td>	
		<td class="col-cell col-cell3 col-cellh">操作</td>			
	</tr>
	
	<s:iterator value="list" var="cFile">
		<tr>
		    <td><s:property value="#cFile.name"/></td>
		    <td><s:property value="#cFile.user.name"/></td>
		    <td>
		    <s:if test="#cFile.user.vip==1">
		    	是
		    </s:if>
		    <s:else>
		    	否
		    ...
		    <td><s:property value="#cFile.createtime"/></td>
		    <td>
		    <table>
		    <tr>
		    <td>
		    <form method="post" action="download.jsp">
		        <input type="hidden" value="<s:property value="#cFile.name"/>" name="filename"/>
		        <input type="hidden" value="<s:property value="path"/>" name="filepath"/>
		        <input class="button gray" type="submit" style="width:60px;margin-top:20px" value="下载"/>
		    </form>
		    </td>
		    <td>
		    <form method="post" action="deleteCFile.action">
		        <input type="hidden" value="<s:property value="#cFile.id"/>" name="doc.id"/>
		        <input type="hidden" value="<s:property value="#cFile.name"/>" name="doc.name"/>
		        <input class="button gray" type="submit" style="width:60px;margin-top:20px" value="删除"/>
		    </form>
		    </td>
		    </tr>
		    </table>
